...
//************************************************************************************************************
//      FUNCTION TO DISPLAY A LIST OF ALL BOOKS
//*************************************************************************************************************
                        ...
                        if(st.rettoken()==0)
                        {
                                ...
                                while(fp1.read((char*)&bk,sizeof(book))&& flag==0)
                                {
                                        if(strcmpi(bk.retbno(),bn)==0)
                                        {
                                                ...
                                                fp.seekp(pos,ios::cur);
                                                fp.write((char*)&st,sizeof(student));
                                                cout<<"\n\n\t Book issued successfully\n\nPlease Note: Write the current date on backside of your book and submit within 15 days or a fine Rs. 1 per day will be imposed";
                                        }
                                }
                                if(flag==0)
